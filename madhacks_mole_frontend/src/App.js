...
function App() {
  return (
    <Router>
      <div className="flex flex-col justify-between items-center w-[25.9375rem] h-[56rem] rounded-[1.25rem] md:mt-[3rem] py-[1.75rem] px-[3rem] shadow-2xl overflow-y-scroll"
          ...
          <div>
              ...
              <div className="hidden">
                  <div className="flex flex-col items-center my-10">
                      ...
                      <h1 className="text-[#3F414E] text-[2rem] font-bold text-center">Upload Your <br/> Mole Mystery!</h1>
                  </div>
                  <p className="text-[#797A7C] text-[1rem] font-regular text-center mt-2">
                      Skin cancer is the <span className="font-bold">most common cancer</span> in the United States, with <span className="font-bold">over 9,500 new cases </span> diagnosed every day.
                      But here’s the good news—early detection can increase the 5-year survival rate to an impressive <span className="font-bold -scale-y-105">99%!</span></p>
              </div>
          </div>
          <Routes>
